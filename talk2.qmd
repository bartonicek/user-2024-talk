...
authors:
  - name: "Adam Bartonicek <br> Dr. Simon Urbanek <br> Dr. Paul Murrell"
...
[https://github.com/bartonicek/plotscape/tree/master/packages/plotscaper](https://github.com/bartonicek/plotscape/tree/master/packages/plotscaper)
...
## Can we only do highlighting on sums? { .center .middle }
...
t + 
  ...
  annotate("text", 1, 8, label = "F(A ∪ B)", size = 6)
...
- We can do highlighting with statistics other than sums
- However, need to have specific algebraic properties:
